macro (add_thirdeye_dir dir)
set (files)
foreach (u ${ARGN})
file (GLOB ALL "${dir}/${u}.[ch]pp")
foreach (f ${ALL})
list (APPEND files "${f}")
list (APPEND THIRDEYE_FILES "${f}")
endforeach (f)
endforeach (u)
source_group ("apps\\thirdeye\\${dir}" FILES ${files})
endmacro (add_thirdeye_dir)

macro (add_runtests_dir dir)
set (files)
foreach (u ${ARGN})
file (GLOB ALL "../thirdeye/${dir}/${u}.[ch]pp")
foreach (f ${ALL})
list (APPEND files "${f}")
list (APPEND UNITTEST_FILES "${f}")
endforeach (f)
endforeach (u)
source_group ("apps\\thirdeye\\${dir}" FILES ${files})
endmacro (add_runtests_dir)
