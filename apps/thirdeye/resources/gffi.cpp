...
sequences[6] = boost::make_tuple(DISP_BMA, 5, mFiles["BMA"][2].data[1]);
sequences[7] = boost::make_tuple(DISP_BMA, 5, mFiles["BMA"][2].data[2]);
sequences[8] = boost::make_tuple(DISP_BMA, 5, mFiles["BMA"][2].data[3]);
sequences[9] = boost::make_tuple(DISP_BMA, 5, mFiles["BMA"][2].data[4]);
sequences[10] = boost::make_tuple(DISP_BMA, 5, mFiles["BMA"][2].data[5]);
sequences[11] = boost::make_tuple(DISP_BMA, 5, mFiles["BMA"][2].data[6]);
