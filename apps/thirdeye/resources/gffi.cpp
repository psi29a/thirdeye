...
sequences[6] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][2].data[1]);
sequences[7] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][2].data[2]);
sequences[8] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][2].data[3]);
sequences[9] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][2].data[4]);
sequences[10] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][2].data[5]);
sequences[11] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][2].data[6]);
sequences[12] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][3].data[1]);
sequences[13] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][3].data[2]);
sequences[14] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][3].data[3]);
sequences[15] = boost::make_tuple(DISP_BMA, 2, mFiles["BMA"][3].data[4]);
sequences[16] = boost::make_tuple(PANB_LEFT, 5, mFiles["BMP"][4].data[0]);
sequences[17] = boost::make_tuple(PANF_LEFT, 5, mFiles["BMP"][6].data[0]);
