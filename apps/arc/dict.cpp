...
//лл  DICT.C                                                                лл
//лл                                                                        лл
//лл  General-purpose dictionary database class                             лл
//лл                                                                        лл
//лл  Version: 1.00 of 6-Mar-92 -- Initial version                          лл
//лл                                                                        лл
...
DI_class *DI_construct(DICT_class *DICT)
{
   ...
   for (DI->bucket=0;DI->bucket<DICT->hash_size;DI->bucket++)
      if ((DI->cur = DICT->root[DI->bucket]) != NULL) break;
...
DICT_entry *DI_fetch(DI_class *DI)
{
   ...
   while (DI->cur == NULL)
      {
      if (++DI->bucket == DI->base->hash_size) break;
