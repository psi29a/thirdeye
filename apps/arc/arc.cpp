...
//лл  ARC.C                                                                 лл
//лл                                                                        лл
//лл  AESOP Resource Compiler main program shell                            лл
//лл                                                                        лл
//лл  V1.00 of 26-Feb-92 -- Initial version                                 лл
//лл  V1.01 of 15-Apr-93 -- V1.01 version identification                    лл
//лл  V1.02 of 12-Sep-93 -- V1.02 version identification                    лл
//лл                                                                        лл
      ...
      if ((argv[i][0] != '/') && (argv[i][0] != '-'))
         ...
         if (!strcasecmp(&argv[i][1],"n"))
            ...
            if (!argv[i][2])
               ...
               DICT_enter(predef,&argv[i][2],D_DEFHEAP)->def =
                  str_alloc(&argv[i][j]);
               }
