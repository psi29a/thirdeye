...
//лл  LEXAN.C                                                               лл
//лл                                                                        лл
//лл  Lexical analyzer/tokenizer class for AESOP ARC compiler               лл
//лл                                                                        лл
//лл  Version: 1.00 of 10-Mar-92 -- Initial version                         лл
//лл                                                                        лл
...
WORD LEX_require(LEX_class *LEX, WORD type, WORD token, BYTE *expect)
{
   ...
   if ((LEX_type(LEX,LEX_NXT) != type) || 
       (LEX_token(LEX,LEX_NXT) != token))
         OK = 0;
